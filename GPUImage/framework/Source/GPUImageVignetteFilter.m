...
- (id)initWithCenter:(CGPoint)pCenter andStart:(CGFloat)pStart andEnd:(CGFloat)pEnd;
{
    ...
    self.vignetteCenter = pCenter;
    self.vignetteColor = (GPUVector3){ 0.0f, 0.0f, 0.0f };
    self.vignetteStart = pStart;
    self.vignetteEnd = pEnd;
