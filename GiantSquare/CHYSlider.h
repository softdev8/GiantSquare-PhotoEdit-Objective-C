 ...
 */
@property(nonatomic, retain) UIImageView *_trackImageViewNormal;
@property(nonatomic, retain) UIImageView *_trackImageViewHighlighted;
@property(nonatomic, retain) UIImageView *_thumbImageView;
